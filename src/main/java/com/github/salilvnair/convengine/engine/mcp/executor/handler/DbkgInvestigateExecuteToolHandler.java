...
public class DbkgInvestigateExecuteToolHandler implements DbToolHandler {
    ...
    public String toolCode() {
        return mcpConfig.getDb().getKnowledgeGraph().getInvestigateExecuteToolCode();
    }

    @Override
    public Object execute(CeMcpTool tool, Map<String, Object> args, EngineSession session) {
        return runtimeService.executeInvestigation(args, session);
    }
}
