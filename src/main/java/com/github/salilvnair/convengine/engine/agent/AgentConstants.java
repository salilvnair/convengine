...
public final class AgentConstants {
    ...
    public static final String TOOL_GROUP_MCP_SERVER = "MCP_SERVER";
    ...
    public static final String CONTEXT_KEY_AGENT = "agent";
    ...
    public static final String AUDIT_STAGE_AGENT_CONTEXT_CLEARED = "AGENT_CONTEXT_CLEARED";
    public static final String VERBOSE_EVENT_AGENT_TOOL_CALL = "AGENT_TOOL_CALL";
    public static final String VERBOSE_EVENT_AGENT_TOOL_RESULT = "AGENT_TOOL_RESULT";
    public static final String VERBOSE_EVENT_AGENT_TOOL_ERROR = "AGENT_TOOL_ERROR";
    public static final String VERBOSE_EVENT_AGENT_FINAL_ANSWER = "AGENT_FINAL_ANSWER";
    public static final String VERBOSE_EVENT_AGENT_DUPLICATE_TOOL_CALL_SUPPRESSED = "AGENT_DUPLICATE_TOOL_CALL_SUPPRESSED";
    public static final String AUDIT_STAGE_AGENT_DUPLICATE_TOOL_CALL_SUPPRESSED = "AGENT_DUPLICATE_TOOL_CALL_SUPPRESSED";
