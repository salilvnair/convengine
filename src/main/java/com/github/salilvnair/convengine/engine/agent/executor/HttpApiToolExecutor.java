...
import com.github.salilvnair.convengine.engine.agent.executor.adapter.HttpApiExecutorAdapter;
import com.github.salilvnair.convengine.engine.agent.executor.adapter.HttpApiRequestingToolHandler;
import com.github.salilvnair.convengine.engine.agent.executor.adapter.HttpApiToolHandler;
import com.github.salilvnair.convengine.engine.agent.executor.http.HttpApiRequestSpec;
import com.github.salilvnair.convengine.engine.agent.executor.http.HttpApiToolInvoker;
...
public class HttpApiToolExecutor implements AgentToolExecutor {
    ...
    public String toolGroup() {
        return AgentConstants.TOOL_GROUP_HTTP_API;
    }
