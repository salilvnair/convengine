...
public class DbkgKnowledgeLookupToolHandler implements DbToolHandler {
    ...
    public String toolCode() {
        return mcpConfig.getDb().getKnowledgeGraph().getKnowledgeLookupToolCode();
    }

    @Override
    public Object execute(CeMcpTool tool, Map<String, Object> args, EngineSession session) {
        return runtimeService.lookupKnowledge(args, session);
    }
}
