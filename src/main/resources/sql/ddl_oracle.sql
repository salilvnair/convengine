...
DROP TABLE ce_semantic_entity_override;
DROP TABLE ce_semantic_relationship_override;
DROP TABLE ce_semantic_join_hint;
DROP TABLE ce_semantic_value_pattern;
DROP TABLE ce_mcp_semantic_embedding;
DROP TABLE ce_user_query_knowledge;
DROP TABLE ce_mcp_user_feedback;
DROP TABLE ce_mcp_user_query_knowledge;
...
CREATE TABLE ce_mcp_user_query_knowledge (
  id NUMBER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE TABLE ce_mcp_user_feedback (
...
CREATE TABLE ce_mcp_semantic_embedding (
  id NUMBER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE TABLE ce_semantic_entity_override (
  id NUMBER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE TABLE ce_semantic_relationship_override (
  id NUMBER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
