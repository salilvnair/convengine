...
import com.github.salilvnair.convengine.engine.agent.executor.adapter.WorkflowActionExecutorAdapter;
...
public class WorkflowActionToolExecutor implements AgentToolExecutor {

    private final Optional<WorkflowActionExecutorAdapter> adapter;

    @Override
    public String toolGroup() {
        return AgentConstants.TOOL_GROUP_WORKFLOW_ACTION;
    }
