...
public class DbkgInvestigatePlanToolHandler implements DbToolHandler {
    ...
    public String toolCode() {
        return mcpConfig.getDb().getKnowledgeGraph().getInvestigatePlanToolCode();
    }

    @Override
    public Object execute(CeMcpTool tool, Map<String, Object> args, EngineSession session) {
        return runtimeService.planInvestigation(args, session);
    }
}
