...
public enum ConvEngineAuditStage {
    ...
    RESPONSE_EXACT,
    EXACT_RESPONSE_RENDERING,
    ASSISTANT_OUTPUT,
    AUTO_ADVANCE_SKIPPED_NO_SCHEMA,
    AUTO_ADVANCE_FACTS,
    POLICY_BLOCK,
    AGENT_SKIPPED_PENDING_CLARIFICATION,
    AGENT_SKIPPED_SCHEMA_INCOMPLETE,
    AGENT_NO_TOOLS_AVAILABLE,
    AGENT_PLAN_LLM_INPUT,
    AGENT_PLAN_LLM_OUTPUT,
    AGENT_DB_SQL_EXECUTION,
    DBKG_QUERY_SQL_EXECUTION,
    DBKG_QUERY_SQL_EXECUTION_ERROR,
    DYNAMIC_SQL_EXECUTION,
    DYNAMIC_SQL_EXECUTION_ERROR,
    AGENT_DB_PREFLIGHT,
    AGENT_DB_PREFLIGHT_REPAIR,
    AGENT_TOOL_CALL,
    AGENT_TOOL_RESULT,
    AGENT_TOOL_ERROR,
    AGENT_FINAL_ANSWER,
