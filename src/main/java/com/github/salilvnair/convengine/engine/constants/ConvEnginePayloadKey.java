...
public final class ConvEnginePayloadKey {
    ...
    public static final String APPLIED_INPUT_PARAMS = "appliedInputParams";
    ...
    public static final String DIALOGUE_ACT_RESOLVE_MODE = "dialogueActResolveMode";
    ...
    public static final String HAS_PENDING_ACTION = "hasPendingAction";
    public static final String HAS_PENDING_SLOT = "hasPendingSlot";
    ...
    public static final String RULE_DB_PHASE = "ruleDbPhase";
    ...
    public static final String EVALUATED_STATE = "evaluatedState";
    ...
    public static final String TASK_METHODS = "taskMethods";
    ...
    public static final String APPROVAL_GRANTED = "approvalGranted";
