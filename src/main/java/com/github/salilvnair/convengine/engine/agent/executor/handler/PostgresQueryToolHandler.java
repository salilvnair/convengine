...
import com.github.salilvnair.convengine.engine.agent.preflight.DbSqlPreflightService;
import com.github.salilvnair.convengine.engine.agent.executor.adapter.DbToolHandler;
...
import com.github.salilvnair.convengine.engine.agent.util.AgentSqlAuditHelper;
...
public class PostgresQueryToolHandler implements DbToolHandler {
    ...
    private final AgentSqlGuardrail sqlGuardrail;
    ...
    public PostgresQueryToolHandler(
            ...
            AgentSqlGuardrail sqlGuardrail,
            ...
            ConvEngineAgentConfig mcpConfig,
    ...
    @Override
    public Object execute(CeAgentTool tool, Map<String, Object> args, EngineSession session) {
        if (args == null) {
    ...
    private String applyInterceptors(String sql, CeAgentTool tool, Map<String, Object> args, EngineSession session) {
    ...
    private void auditExecution(
        ...
        AgentSqlAuditHelper.auditSqlExecution(
                auditService,
                verbosePublisher,
                session,
                null,
