package com.github.salilvnair.convengine.engine.agent.query.semantic.embedding;
...
import com.github.salilvnair.convengine.engine.agent.query.semantic.model.*;
...
public class SemanticEmbeddingService {
    ...
    public SemanticEmbeddingRebuildResponse rebuildFromSemanticModel(SemanticEmbeddingRebuildRequest request) {
        ...
        ConvEngineAgentConfig.Db.Semantic cfg = semanticConfig();
    ...
    private void upsertEmbedding(ConvEngineAgentConfig.Db.Semantic cfg,
                                 String namespace,
                                 String targetType,
                                 String targetName,
                                 float[] embedding,
    ...
    private void clearNamespace(String namespace, ConvEngineAgentConfig.Db.Semantic cfg) {
    ...
    private ConvEngineAgentConfig.Db.Semantic semanticConfig() {
        if (mcpConfig.getDb() == null) {
            return new ConvEngineAgentConfig.Db.Semantic();
        }
        ConvEngineAgentConfig.Db.Semantic cfg = mcpConfig.getDb().getSemantic();
        return cfg == null ? new ConvEngineAgentConfig.Db.Semantic() : cfg;
    }
