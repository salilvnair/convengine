...
VALUES
  (9001, 'db.semantic.catalog', 'DB', 'ANY', 'ANY', 1,
   'Semantic query/schema knowledge retrieval for similar issue diagnosis', CURRENT_TIMESTAMP),
  (9003, 'postgres.query', 'DB', 'ANY', 'ANY', 1,
   'Execute raw read-only Postgres SQL generated by the LLM.', CURRENT_TIMESTAMP),
...
-- ---------------------------------------------------------------------------
INSERT OR REPLACE INTO ce_mcp_schema_knowledge (id, table_name, column_name, description, tags, valid_values)
VALUES
