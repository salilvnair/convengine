...
public class DbkgCaseResolveToolHandler implements DbToolHandler {
    ...
    public String toolCode() {
        return mcpConfig.getDb().getKnowledgeGraph().getCaseResolveToolCode();
    }

    @Override
    public Object execute(CeMcpTool tool, Map<String, Object> args, EngineSession session) {
        return runtimeService.resolveCase(args, session);
    }
}
